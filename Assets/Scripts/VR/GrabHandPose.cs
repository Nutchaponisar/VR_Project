...
public class GrabHandPose : MonoBehaviour
{
    ...
    public SaveHandModelForWeapon rightHandPose;
    public SaveHandModelForWeapon leftHandPose;
    ...
    {
        if(arg.interactorObject is DistanceGrab)
        {
            SaveHandModelForWeapon handData = arg.interactorObject.transform.GetComponentInChildren<SaveHandModelForWeapon>();
            handData.animator.enabled = false;

            if(handData.handType == SaveHandModelForWeapon.HandModelType.Right)
            {
    ...
    public void SetHandDataValues(SaveHandModelForWeapon h1, SaveHandModelForWeapon h2)
    {
    ...
    public void SetHandData(SaveHandModelForWeapon h, Vector3 newPosition, Quaternion newRotation, Quaternion[] newBonesRotation)
    {
    ...
    public IEnumerator SetHandDataRoutine(SaveHandModelForWeapon h, Vector3 newPosition, Quaternion newRotation, Quaternion[] newBonesRotation, Vector3 startingPosition, Quaternion startingRotation, Quaternion[] startingBonesRotation)
    {
        float timer = 0;
    ...
    public static void MirrrorRightPose()
    {
...
#endif
    public void MirrorPose(SaveHandModelForWeapon poseToMirror, SaveHandModelForWeapon poseUsedToMirror)
    {
